...
These versions may intentionally differ. The v0.2.0 toolkit release adds input hardening, Git/SHA-256 evidence binding, signed verification provenance and end-to-end integration without changing the 32-control assessment model, states or gate semantics. Therefore the assessment contract remains `0.1.1` unless those assessment semantics are deliberately revised.
...
The v0.2.0 release has a separate five-direction pre-release audit. See `audits/2026-09-26-v0.2.0-pre-release-audit.md`.
